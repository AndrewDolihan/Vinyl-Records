...
/**
 * Orders the table by Left in Stock and displays it 
 */
$insertSql = "SELECT * FROM `Vinyl Records` ORDER BY `Left in Stock` DESC";
...
<html>
    ...
    <body>
        ...
        <!-- Sort by Vinyl ID button -->
        <form action="viewByID.php" method="POST" >
            
            <p><input type="submit" name="order"  value="Order By ID"></p>
        </form>
